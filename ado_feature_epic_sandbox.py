...
def build_jira_fields_from_ado(wi: Dict) -> Dict:
    ...
    # Feature Type (customfield_12451)
    ...
    # Identified Area (customfield_12452)
    ...
    # Control Type (customfield_12455)
    ...
    # Change Order (customfield_12456)
    ...
    # Client Due Date (customfield_12459)
    ...
    # Content Team Solutioning Support (customfield_12460)
    ...
    # Client Scope (customfield_12461)
...
def migrate_all():
    ...
    # Ascending ID order
    wiql = (
"SELECT [System.Id] FROM WorkItems WHERE [System.CreatedDate] >= '2025-12-01' AND [System.CreatedDate] <= '2025-12-10'AND [System.WorkItemType] = 'Feature'"    )
